...
{
    [Serializable]
    [PostProcess(typeof(D2RainsFastPERenderer), PostProcessEvent.AfterStack, "UB/Simple2dWeatherEffects/LWRP/D2RainsFastPE")]
    ...
    public sealed class D2RainsFastPERenderer : PostProcessEffectRenderer<D2RainsFastPE>
    {
        ...
        {
            var sheet = context.propertySheets.Get(Shader.Find("Hidden/UB/Simple2dWeatherEffects/LWRP/D2RainsFast"));

...
{
    [Serializable]
    [PostProcess(typeof(D2RainsPERenderer), PostProcessEvent.AfterStack, "UB/Simple2dWeatherEffects/LWRP/D2RainsPE")]
    ...
    public sealed class D2RainsPERenderer : PostProcessEffectRenderer<D2RainsPE>
    {
        ...
        {
            var sheet = context.propertySheets.Get(Shader.Find("Hidden/UB/Simple2dWeatherEffects/LWRP/D2Rains"));

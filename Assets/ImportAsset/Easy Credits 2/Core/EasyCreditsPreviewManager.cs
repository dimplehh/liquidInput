...
namespace Onerat.EasyCredits
{
    ...
    public class EasyCreditsPreviewManager : MonoBehaviour
    {
        ...
        public void ClearCredits()
        {
            ...
            DestroyImmediate(this.transform.GetChild(0).transform.GetChild(0).gameObject);
            canvasManager.DistanceToMove = 0;
            DestroyImmediate(this.transform.GetChild(0).GetComponent<UnityEngine.UI.CanvasScaler>());
            DestroyImmediate(this.transform.GetChild(0).GetComponent<Canvas>());

...
{
    [Serializable]
    [PostProcess(typeof(D2SnowsPERenderer), PostProcessEvent.AfterStack, "UB/Simple2dWeatherEffects/LWRP/D2SnowsPE")]
    ...
    public sealed class D2SnowsPERenderer : PostProcessEffectRenderer<D2SnowsPE>
    {
        ...
        {
            var sheet = context.propertySheets.Get(Shader.Find("Hidden/UB/Simple2dWeatherEffects/LWRP/D2Snows"));
